...
# Load the saved RF model and vectorizer
model = joblib.load(r"C:\Users\river\Documents\CybersecurityDissertation\Models\rf_model.pkl")
tfidf = joblib.load(r"C:\Users\river\Documents\CybersecurityDissertation\Models\tfidf_vectorizer_rf.pkl")
